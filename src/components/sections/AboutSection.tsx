    ...
    <section className="pt-32 pb-24 overflow-x-hidden">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="border-l border-outline-variant/30 pl-8">
            <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed font-light">
              In VISION, crediamo che il confine tra il mondo fisico e quello digitale debba essere invisibile. La nostra missione è progettare esperienze VR immersive che non si limitino a intrattenere, ma trasformino il modo in cui percepiamo la connessione umana e l'intrattenimento digitale.
            </p>
      ...
      <div className="w-full px-8 md:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
          <div>
            <h2 className="font-headline text-4xl font-bold tracking-tight">IL NOSTRO TEAM</h2>
...
const TEAM_MEMBERS = [
  { name: 'Domenico Formisano', role: 'Divisione IT', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBf0NmNp9ZpZgaMmVZMKIrAbzOGPOSTEOuK3dbirJDvV1JIKwffnH9vPrpiR82KW73M9NCBUUSueHamFovLv6IS3csNm-_JAQYj11ahpExnGor8y_4FA-0J7SiXs0v04JSzDr8XQ9ObVp_Pmq46qu2fCNJOwnIN9nhSmkPTTazjjcc9ZNtJSI0IxTA7T18iKJQ-fevOnhvF3ZrcJy7BzO7EAP90FVbVA6iyeB2AvFH9RGaQCrJW7XuTXuR8qTNyqw9LRE0ipz7yQK0' },
  { name: 'Fabrizio Palumbo', role: 'Divisione IT', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB0sdz2WketkgHETukzAcrJ_7rt-ahBdjuOYM5TiAED62iG-28pJrQ0qgaMfz5SPKqfiUkncVq5MG3UwiST2uYKxbCjnvB_VkljZEnnHKji05nzGH_PkV5-U7609uo0SD6nR5ECumxB1VGz5fJQ6FqMpGvqo3T7SSCTe6GkCFYRKLNwD3TN3eHdsewV-8gi1mnuZgT2SDEWjxdLJ3yx7ThRJ5tAi5XjZlWkvlQL5aUTXtRSanV69JcsyyT8VspIywQqJOgnvjxCZrc' },
  { name: 'Salvatore Minervino', role: 'Divisione Finance', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC4ZcqmklX3ZBrB2Yt6VOiectKuvLGtadrCu_d_u0e0wfMR3HEEQ7spVsgi_bN_VXdshNZmci2WCA08m7QWvIQfkPuNhhxZmzYqilJUwnG-1DegtJHmntIAVX6GmQwOOMYQuCHMvzCopNZyaw8fIeDvSB96AAJUfPd0k8ptFiYY6BzF4sE-nGuOvuyTPip4YvYisaFC35Z3yHjsUrghi6nfg3Rui5825VLLRZgUl45u17Hnys37iug-owaTrEYpFZJ62M9DGplamc8' },
  { name: 'Francesco Aiello', role: 'Divisione Tech', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCa8RGAq5c-O2H4BUcB6lY0HBAwjvdRAIsuH1m74wShxUg4_ZgjevHYayp-zKlDP8Jo9bqs5duPm-GNcZ2I2Uhbiy1iKIsUe2m0ofrIpQhKK8Qstx7ajyR2ELiQ_QSzKVnU-J108v8C2HllDO8Us8Jctj0MKoMipzVAJDWBypiM7OgqIp1mqyOruopGs7RHtOt_aM77E6M66sL8HhbFT3gdGGAt4oeWoEguJ7-YbN164weINPxpfMFxhHB0fongn0lqTC0B4cmH9RE' },
  { name: 'Giuseppe Ottaiano', role: 'Divisione Marketing', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCWSZJkLZ4E3-NbZh_clUvGzJn-hOwBtjBV0chRbH_OIJ6X4gYOFRndnUuFszfLoB--1dfpQ9MpHvHhoMPLDRn4KiPGPNBpZeoeGakhOfLbT0RclzAwYhcg60FQc8ZIPar2AEyQ3TWJSNwHhOoSZD_rd4Ey8OmnZ293aJoKtqgIVSvfkyccyZACSN52CL-_12cLtbrLMLQdNa2DcfZuE23haJN5TxAfzr9Ukier27yyiWR2LsVbrtVP-E1pssp5E2fJN-jqHFcezHE' },
  { name: 'Simone Accadia', role: 'Divisione Marketing', roleColor: 'text-primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBoOlGhHIiQRNYSTV6t7aijI6h7KoruWndLuVZiBiSfqMY0fP5iHfuA8QQ9girygxBfgPFUxeQj37w7qCDg74NqdPUwg66w4sMXxO-0nIt9l0xxG5zG7RR_IFZCtQIy0pjjbdJCZ-xEKFp7dkr2WW3KVNyjDB3S4qHMS0oh8BpZvWvgvYo3wPGLaeQwhXWHXD7bZ1NiSsz69PSRL5lRHehVvXmwUYZI80DB-DwpIPTVB1wp_mzTe7wu16Yi95A-XGVIOhWZBQ5Zs4U' }
];
